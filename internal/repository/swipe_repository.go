...
type SwipeRepository interface {
	...
	GetLikesSent(ctx context.Context, entityID uuid.UUID, limit, offset, expiryHours int) ([]entities.Swipe, error)
	GetLikesYou(ctx context.Context, entityID uuid.UUID, limit, offset, expiryHours int) ([]entities.Swipe, error)
	CountLikesYou(ctx context.Context, entityID uuid.UUID, expiryHours int) (int64, error)
