...
func SeedMasterData(db *gorm.DB) error {
	return db.Transaction(func(tx *gorm.DB) error {
		...
		configs := []entities.AppConfig{
			...
			{Key: "swipe_impression_cooldown_premium", Value: "0"},
			// {Key: "swipe_impression_cooldown_free", Value: "60"},
			{Key: "swipe_impression_cooldown_free", Value: "10"},
			// {Key: "swipe_impression_cooldown_boost", Value: "3"},
			{Key: "swipe_impression_cooldown_boost", Value: "0"},
